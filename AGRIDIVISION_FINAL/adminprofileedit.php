...
if (isset($_POST['fname'])) {
    ...
    if (!empty($_FILES['profileimg']['name'])) {
        ...
        if (!in_array($imageFileType, $allowedFormats)) {
            ...
            $destinationPath = "C:/xampp/htdocs/AGRIDIVISION_FINAL/assets/img/admin/";
            ...
            if (move_uploaded_file($_FILES['profileimg']['tmp_name'], $destinationFile)) {
                ...
                $sql = "UPDATE admin SET fname='$fname', lname='$lname', email='$email', num='$num', prov='$prov', mun='$mun', brgy='$brgy', street='$street', zip='$zip', dob='$dob', password='$password', profileimg='$newImageNameWithoutExtension'  WHERE id=$user_id";
    
                if (mysqli_query($conn, $sql)) {
                    $alertMessage = "Admin profile has been updated";
                } else {
                    $alertMessage = "Error updating admin profile: " . mysqli_error($conn);
                }
            } else {
        ...
        // Update the admin record in the database without changing the image
        $user_id = $_SESSION['user_id'];
        $sql = "UPDATE admin SET fname='$fname', lname='$lname', email='$email', num='$num', prov='$prov', mun='$mun', brgy='$brgy', street='$street', zip='$zip', dob='$dob', password='$password' WHERE id=$user_id";
    ...
    function handleModalClose() {
        ...
        switch (resultMessage) {
            case "Passwords do not match":
                window.location.replace("adminprofileedit.php");
                break;
            case "Admin profile has been updated":
