...
if (isset($_POST['fname'])) {
    ...
    if ($password != $repass) {
        ...
        if ($coordinates) {
            ...
            $destinationPath = "C:/xampp/htdocs/AGRIDIVISION_FINAL/assets/img/municipal_agriculturist/" . $newImageName . ".jpg";
            ...
            if (move_uploaded_file($_FILES['profileimg']['tmp_name'], $destinationPath)) {
                ...
                $sql = "INSERT INTO municipal_agriculturist (admin_id, fname, lname, email, num, prov, mun, brgy, street, zip, dob, password, profileimg, regdate, latitude, longitude)"
                    . " VALUES ('$admin_id', '$fname', '$lname', '$email', '$num', '$prov', '$mun', '$brgy', '$street', '$zip', '$dob', '$password', '$newImageName', '$date', '$latitude', '$longitude')";
...
<script>
    ...
    function handleModalClose() {
        ...
        if (resultMessage === "New record added successfully") {
            ...
            location.replace("admintables.php");
        }
    }
