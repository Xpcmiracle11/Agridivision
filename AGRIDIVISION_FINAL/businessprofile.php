...
<script>
    ...
    document.getElementById('buspermit').innerHTML = '<?php echo isset($buspermit) ? $buspermit : ""; ?>';
    document.getElementById('crop').innerHTML = '<?php echo isset($crop) ? $crop : ""; ?>';
