...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM municipal_agriculturist WHERE id = $uid";
    ...
    if (!empty($_FILES['profileimg']['name'])) {
        ...
        if (!in_array($imageFileType, $allowedFormats)) {
            ...
            if (move_uploaded_file($_FILES['profileimg']['tmp_name'], $destinationFile)) {
                $sql = "UPDATE municipal_agriculturist SET fname='$fname', lname='$lname', email='$email', num='$num', prov='$prov', mun='$mun', brgy='$brgy', street='$street', zip='$zip', dob='$dob', password='$password', profileimg='$newImageNameWithoutExtension'  WHERE id=$uid";
        ...
        $sql = "UPDATE municipal_agriculturist SET fname='$fname', lname='$lname', email='$email', num='$num', prov='$prov', mun='$mun', brgy='$brgy', street='$street', zip='$zip', dob='$dob', password='$password' WHERE id=$uid";
    ...
    function handleModalClose() {
        ...
        switch (resultMessage) {
            case "Passwords do not match.":
                window.location.replace("admineditmun.php?id=<?php echo $uid; ?>");
                break;
            case "User profile has been updated":
                window.location.replace("admintables.php");
                break;
