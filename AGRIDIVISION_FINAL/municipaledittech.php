...
include 'municipaledittech.html';
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM brgy_tech WHERE id = $uid";
    ...
    if (!empty($_FILES['profileimg']['name'])) {
        ...
        if (!in_array($imageFileType, $allowedFormats)) {
            ...
            if (move_uploaded_file($_FILES['profileimg']['tmp_name'], $destinationFile)) {
                $sql = "UPDATE brgy_tech SET fname='$fname', lname='$lname', email='$email', num='$num', prov='$prov', mun='$mun', brgy='$brgy', street='$street', zip='$zip', dob='$dob', password='$password', profileimg='$newImageNameWithoutExtension'  WHERE id=$uid";
        ...
        $sql = "UPDATE brgy_tech SET fname='$fname', lname='$lname', email='$email', num='$num', prov='$prov', mun='$mun', brgy='$brgy', street='$street', zip='$zip', dob='$dob', password='$password' WHERE id=$uid";
    ...
    function handleModalClose() {
        ...
        switch (resultMessage) {
            case "Passwords do not match.":
                window.location.replace("municipaledittech.php?id=<?php echo $uid; ?>");
                break;
            case "User profile has been updated":
                window.location.replace("municipaltables.php");
                break;
